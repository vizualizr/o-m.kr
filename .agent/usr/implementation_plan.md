...
## 목적
Google Sheets CMS 파이프라인의 데이터 흐름을 명확히 기록하여 사용자가 전체 구조를 쉽게 이해하고 잊지 않도록 하며, 모호한 폴더 구조를 정리하고 이를 `development-rules.md`에 반영합니다.

## 제안 사항
1. **데이터 플로우 문서화**: `development-rules.md` 내에 Mermaid 다이어그램을 포함한 "CMS Pipeline & Data Flow" 섹션을 추가합니다.
2. **폴더 구조 정리**: 
